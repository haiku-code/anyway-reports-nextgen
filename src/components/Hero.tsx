      ...
      */}
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-16 xl:px-20">
          ...
          >
            <HeroSubtitle>
              2,587,000 תלמידים וילדי גן יפתחו את שנת הלימודים ב-1/9. הם יחצו כבישים וצמתים בדרכם אל
              מוסדות הלימוד, בין אם ברגל, באופניים, בקורקינט או בכלי רכב. ב-5 השנים האחרונות נפגעו
              6,260 ילדים בדרכים הללו - שחלקן מסוכנות. ynet מציג את מפת ANYWAY מבית "נתון לשינוי",
              שחושפת את אותם הכבישים: כתבו את שם המוסד החינוכי, גלו אותם במפה והצילו חיים
            </HeroSubtitle>
          </div>
